...
class ShopingCartPage extends GetView<ShopingCartController> {
...
Scaffold buildShopingCartView() {
  return Scaffold(
    ...
    bottomNavigationBar: shopingCartBottomView(),
    body: buildShopingCartBody(),
  );
}

Container shopingCartBottomView() {
  ShopingCartController shopingCartController =
      Get.find<ShopingCartController>();
  return Container(
    height: 55,
    color: Colors.white,
    child: Row(
        ...
        Obx(() => TextButton.icon(
            onPressed: () {
              shopingCartController.ifAllSele =
                  !shopingCartController.ifAllSele;
              shopingCartController.allSeleTap(shopingCartController.ifAllSele);
            },
            icon: Icon(
              shopingCartController.ifAllSele
                  ? Icons.radio_button_checked
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Text('滑动删除',
                              textAlign: TextAlign.right,
                              style:
                                  SeaFont.s14FontTextStyle(color: Colors.white))
                        ],
                      )),
